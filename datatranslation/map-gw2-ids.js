...
import itemsJson from "./mapping/items.json" assert { type: "json" };
import skillsJson from "./mapping/skills.json" assert { type: "json" };
import traitsJson from "./mapping/traits.json" assert { type: "json" };
import itemstatsJson from "./mapping/itemstats.json" assert { type: "json" };
import specializationsJson from "./mapping/specializations.json" assert { type: "json" };
